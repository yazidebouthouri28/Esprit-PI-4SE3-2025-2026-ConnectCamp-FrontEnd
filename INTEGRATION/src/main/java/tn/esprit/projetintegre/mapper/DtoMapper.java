    ...
    public TransactionResponse toTransactionResponse(Transaction entity) {
        ...
        return TransactionResponse.builder()
                ...
                .userName(entity.getWallet() != null && entity.getWallet().getUser() != null
                        ...
                        : null)
                .createdAt(entity.getCreatedAt())
                .isFraud(Boolean.TRUE.equals(entity.getIsFraud()))
                .fraudProbability(entity.getFraudProbability() != null ? entity.getFraudProbability() : 0.0)
                .riskLevel(entity.getFraudRiskLevel())
                .build();
    }
