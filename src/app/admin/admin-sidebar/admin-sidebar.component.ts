...
export class AdminSidebarComponent {
  ...
  navMarket: NavItem[] = [
    ...
    { id: 'orders', label: 'Orders', icon: 'M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01', roles: ['ADMIN'] },
    { id: 'rentals_management', label: 'Rentals Management', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', roles: ['ADMIN'] }
  ];
  ...
  navModules: NavItem[] = [
    ...
    { id: 'reservations', label: 'Reservations', icon: 'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z', roles: ['ADMIN'] },
    ...
    { id: 'flagged_messages', label: 'Flagged Messages', icon: 'M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z', roles: ['ADMIN'] },
    { id: 'sponsor_assignment', label: 'Sponsor Assignment', icon: 'M12 8c-1.657 0-3 .895-3 2v1H7a2 2 0 00-2 2v4a2 2 0 002 2h10a2 2 0 002-2v-4a2 2 0 00-2-2h-2v-1c0-1.105-1.343-2-3-2z', roles: ['ADMIN'] },
    { id: 'throttle', label: 'Throttle Monitor', icon: 'M13 10V3L4 14h7v7l9-11h-7z', roles: ['ADMIN'] }
  ];

  filterRole(items: NavItem[]): NavItem[] {
    const userRole = this.user()?.role || '';
    return items.filter((item: NavItem) => !item.roles || item.roles.includes(userRole));
  }
  ...
  selectSection(id: string) {
    ...
    if (url.includes('/admin/') || url.includes('/organizer/')) {
